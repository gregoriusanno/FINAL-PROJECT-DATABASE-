<?php
    ...
    $sql = "SELECT * FROM course WHERE class = 12";
            ...
            <div class="row g-3">
                        ...
                        for($i = 1 ; $i <=4 ; $i++){
                            ...
                            if($i == 1 || $i == 4){
                                ...
                                <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                                    <a class="position-relative d-block overflow-hidden" href="../Course/12/<?php echo $page["page"];?>">
                ...
                ?>
                    <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                        <a class="position-relative d-block h-100 overflow-hidden" href="../Course/12/<?php echo $page["page"];?>">
