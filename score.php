...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($_POST['quizcheck']) and count($_POST['quizcheck']) == 5 and !empty($_POST['Name'])){
            ...
            $hdr = "select * from chapterquiz where QuizID = $qID";
            $hder = mysqli_query($conn,$hdr);
            $hader = mysqli_fetch_assoc($hder);
            $header = $hader['header'];
    ...
    $rtrn = "select chapter.page from chapter JOIN chapterquiz ON (chapter.ChapterID = chapterquiz.ChapterID) where QuizID = $qID";
    $rtrn1 = mysqli_query($conn,$rtrn);
    $return = mysqli_fetch_assoc($rtrn1);
...
<body>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    ?>
                    <h1 class="display-3 text-white animated slideInDown">Study More!</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <h5 class="text-white"> Don't be sad</h5>
                            </ol>
                        </nav>
                    <?php
                    }
            ...
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <p align="center">
                        <a class="btn btn-lg-refin upscale-30 py-1 px-4" href="<?php echo $return['page']?>">Return</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <i class="bi bi-x-circle display-1 text-primary"></i>
                        <h1 class="display-1"><?php echo $userName?></h1>
